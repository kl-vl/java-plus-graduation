...
public class CommentControllerPrivate {
    ...
    public CommentDto createComment(
            ...
            @Valid @RequestBody CommentDto commentDto) throws UserNotFoundException, EventNotFoundException, ServiceException {
    ...
    public List<CommentDto> findUserComments(
            @PathVariable @Positive Long userId,
            @PageableDefault(page = 0, size = 10, sort = "created", direction = Sort.Direction.DESC) Pageable pageable) throws UserNotFoundException, ServiceException {
